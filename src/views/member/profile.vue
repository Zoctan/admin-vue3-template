<template>
  <el-card class="box-card">
    ...
    <el-descriptions :column="3" size="large" border>
      <template #extra>
        <el-button class="button" @click="dialogProfileFormVisible = true"
          >update profile</el-button
        >
        <el-button class="button" @click="dialogPasswordFormVisible = true"
      ...
      <el-descriptions-item>
        <template #label>
          <div class="cell-item">
            <el-icon>
              <component
                :is="memberGenderMap[member.memberData.gender].label"
              ></component> </el-icon
            >Gender
          </div>
        </template>
  ...
  <el-dialog
    v-model="dialogProfileFormVisible"
  ...
  >
    ...
    <template #footer>
      <span class="dialog-footer">
        ...
        <el-button type="danger" @click="resetForm(profileFormRef)"
          >Reset</el-button
        >
        <el-button
          type="primary"
  ...
  <el-dialog
    v-model="dialogPasswordFormVisible"
  ...
  >
    ...
    <template #footer>
      <span class="dialog-footer">
        ...
        <el-button type="danger" @click="resetForm(passwordFormRef)"
          >Reset</el-button
        >
        <el-button
          type="primary"
...
import {
  updateProfile,
  validateOldPassword as validateMemberOldPassword,
  updatePassword,
} from "api/member";
